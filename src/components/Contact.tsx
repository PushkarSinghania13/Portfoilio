...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M11.997 0C5.373 0 0 5.373 0 12s5.373 12 11.997 12C18.627 24 24 18.627 24 12S18.627 0 11.997 0zM8.82 4.809c.534 0 .967.433.967.967s-.433.968-.967.968-.968-.434-.968-.968.434-.967.968-.967zm6.36 0c.533 0 .967.433.967.967s-.434.968-.967.968-.967-.434-.967-.968.433-.967.967-.967zm-3.18 2.904c2.735 0 4.954 2.22 4.954 4.955s-2.219 4.955-4.954 4.955-4.955-2.22-4.955-4.955 2.22-4.955 4.955-4.955z"/>
        </svg>
      )
    }
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
              ...
              <CardContent className="p-8 text-center space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button 
                    variant="outline"
                    size="lg"
                    className="w-full border-accent text-accent hover:bg-accent hover:text-accent-foreground font-medium px-8 py-3 rounded-xl transition-all duration-300 hover:scale-105"
                  >
                    Download Resume
                  </Button>
                </div>
            ...
            <div className="text-center text-primary-foreground/60 text-sm">
              <p>© 2024 Pushkar Singhania. Built with React & Tailwind CSS.</p>
            </div>
          </div>
        </div>
      </div>
